...
export interface ApiCollectorLogCollectorLog
  extends Struct.CollectionTypeSchema {
  collectionName: 'collector_logs';
  info: {
    description: 'Worker\u91C7\u96C6\u65E5\u5FD7\u8BB0\u5F55';
    displayName: '\u91C7\u96C6\u65E5\u5FD7';
    pluralName: 'collector-logs';
    singularName: 'collector-log';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    level: Schema.Attribute.Enumeration<['debug', 'info', 'warning', 'error']> &
      Schema.Attribute.DefaultTo<'info'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::collector-log.collector-log'
    > &
      Schema.Attribute.Private;
    message: Schema.Attribute.Text & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    task: Schema.Attribute.Relation<'manyToOne', 'api::crawl-task.crawl-task'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCrawlTaskCrawlTask extends Struct.CollectionTypeSchema {
  collectionName: 'crawl_tasks';
  info: {
    description: '\u5546\u54C1\u91C7\u96C6\u4EFB\u52A1\u7BA1\u7406';
    displayName: '\u91C7\u96C6\u4EFB\u52A1';
    pluralName: 'crawl-tasks';
    singularName: 'crawl-task';
  };
  options: {
    draftAndPublish: false;
  };
