...
const ProductHistoryPage: React.FC = () => {
  ...
  const columns: ColumnsType<ProductHistory> = [
    ...
    { title: '总销量', dataIndex: 'totalSales', width: 100, render: formatNumber },
    { title: '价格', dataIndex: 'price', width: 100, render: formatCurrency },
    { title: '本次销量', dataIndex: 'sales', width: 100, render: formatNumber },
    { title: '采集时间', dataIndex: 'collectTime', width: 180, render: formatDate },
    {
      title: '商品链接',
